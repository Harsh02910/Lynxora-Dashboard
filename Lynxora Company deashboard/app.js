...
// ── State ─────────────────────────────────────────────────────────────────────
let trackedFlipkartList = JSON.parse(localStorage.getItem('lynxora_flipkart_tracker') || '[]');
let fkSearchQuery       = '';
...
function saveFlipkartToTracker() {
  ...
  renderFkTrackerTable();
  updateFkTrackedBadge();
  showToast(`Saved ${sku} (${formatCurrency(bd.sp)}) to Flipkart Tracker! ✓ Click 'Tracked Prices' tab to view.`, 'success');
}

// ── Persist ───────────────────────────────────────────────────────────────────
function saveFkTracking() {
